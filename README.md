# Geometry Dash · TMA (v0.2)

Браузерная игра в стиле Geometry Dash, спроектированная как Telegram Mini App.
Эта версия включает **Этапы 1–5 + расширение Этапа 4** из ТЗ. Запускается локально
в браузере одной командой, без бэка и без обязательной Telegram-инфраструктуры.
